...
const BlogCard = ({ blog }: Props) => {
  ...
  return (
    <div className="bg-indigo-950 rounded-md overflow-hidden ">
      ...
      />
      <div className="p-6 ">
        <p className="rounded-small px-6 py-1.5 bg-rose-500 text-white w-fit">
          News
        </p>
        <h1 className="sm:text-lg text-base cursor-pointer hover:text-gray-100 hover:underline transition-all duration-300 mt-6 text-gray-200 leading-[1.6rem] font-bold">
          {title}
        </h1>
